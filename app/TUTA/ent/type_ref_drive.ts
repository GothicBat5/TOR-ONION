...
export function createDriveFolder(values: StrippedEntity<DriveFolder>): 
  DriveFolder {
...
export function createDriveFile(values: StrippedEntity<DriveFile>): 
  DriveFile {
...
export function createDriveFileRef(values: StrippedEntity<DriveFileRef>): 
  DriveFileRef {
...
export function createDriveFileBag(values: StrippedEntity<DriveFileBag>): 
  DriveFileBag {
...
export function createDriveFolderBag(values: StrippedEntity<DriveFolderBag>): 
  DriveFolderBag {
...
export function createDriveGroupRoot(values: StrippedEntity<DriveGroupRoot>): 
  DriveGroupRoot {
...
export function createDriveUploadedFile(values: StrippedEntity<DriveUploadedFile>): 
  DriveUploadedFile {
...
export function createDrivePostIn(values: StrippedEntity<DrivePostIn>): 
  DrivePostIn {
...
export function createDriveItemPostIn(values: StrippedEntity<DriveItemPostIn>): 
  DriveItemPostIn {
...
export function createDriveItemPostOut(values: StrippedEntity<DriveItemPostOut>): 
  DriveItemPostOut {
...
export function createDriveItemPutIn(values: StrippedEntity<DriveItemPutIn>): 
  DriveItemPutIn {
...
export function createDriveItemDeleteIn(values: StrippedEntity<DriveItemDeleteIn>): 
  DriveItemDeleteIn {
...
export function createDriveFolderServicePostIn(values: StrippedEntity<DriveFolderServicePostIn>): 
  DriveFolderServicePostIn {
    return Object.assign(create(typeModels[DriveFolderServicePostInTypeRef.typeId], 
                                DriveFolderServicePostInTypeRef), values)
}
...
export function createDriveFolderServicePostOut(values: StrippedEntity<DriveFolderServicePostOut>): 
  DriveFolderServicePostOut {
    return Object.assign(create(typeModels[DriveFolderServicePostOutTypeRef.typeId], 
                                DriveFolderServicePostOutTypeRef), values)
}
...
export function createDriveRenameData(values: StrippedEntity<DriveRenameData>): 
  DriveRenameData {
    return Object.assign(create(typeModels[DriveRenameDataTypeRef.typeId], 
                                DriveRenameDataTypeRef), values)
}
...
export function createDriveFolderServicePutIn(values: StrippedEntity<DriveFolderServicePutIn>): 
  DriveFolderServicePutIn {
    return Object.assign(create(typeModels[DriveFolderServicePutInTypeRef.typeId], 
                                DriveFolderServicePutInTypeRef), values)
}
...
export function createDriveFolderServiceDeleteIn(values: StrippedEntity<DriveFolderServiceDeleteIn>): 
  DriveFolderServiceDeleteIn {
    return Object.assign(create(typeModels[DriveFolderServiceDeleteInTypeRef.typeId], 
                                DriveFolderServiceDeleteInTypeRef), values)
}
...
export function createDriveCopyServicePostOut(values: StrippedEntity<DriveCopyServicePostOut>): 
  DriveCopyServicePostOut {
    return Object.assign(create(typeModels[DriveCopyServicePostOutTypeRef.typeId], 
                                DriveCopyServicePostOutTypeRef), values)
}
...
export function createDriveItemServiceDeleteOut(values: StrippedEntity<DriveItemServiceDeleteOut>): 
  DriveItemServiceDeleteOut {
    return Object.assign(create(typeModels[DriveItemServiceDeleteOutTypeRef.typeId], 
                                DriveItemServiceDeleteOutTypeRef), values)
}
